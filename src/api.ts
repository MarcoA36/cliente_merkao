...
export function createCategory(token: string, input: { name: string; slug?: string }) {
...
export function updateCategory(token: string, id: string, input: { name: string; slug?: string }) {
...
export function createBrand(token: string, input: { name: string; slug?: string }) {
...
export function updateBrand(token: string, id: string, input: { name: string; slug?: string }) {
