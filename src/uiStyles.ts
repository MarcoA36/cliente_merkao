...
export const shell = "min-h-screen bg-merkao-background font-sans text-merkao-text antialiased";

export const brandBlock = "flex items-center gap-2.5 px-5 pb-3 pt-0.5";
export const brandBlockCompact = "flex items-center gap-2.5 pb-1.5";
export const brandMark =
  "flex h-8 w-8 items-center justify-center rounded-merkao bg-merkao-primary text-sm font-black text-white";
export const brandTitle = "m-0 text-[18px] font-extrabold leading-[1.1] text-merkao-primary";
export const brandSubtitle = "mb-0 mt-[2px] text-[11px] font-semibold text-merkao-muted";
...
export const smallButton = "!min-h-8 !px-2.5 !py-1.5 !text-xs";
export const secondaryIconButton = cn(secondaryButton, "w-9 !px-0");
export const iconButton =
  "inline-flex h-8 w-8 items-center justify-center rounded-merkao border-0 bg-transparent p-0 text-merkao-muted transition-colors duration-150 hover:bg-merkao-surfaceAlt hover:text-merkao-text disabled:cursor-not-allowed disabled:opacity-[.55]";
...
export const fieldInput =
  "min-h-9 w-full rounded-merkao border border-merkao-border bg-white px-2.5 py-2 text-[13px] text-merkao-text outline-none transition-[border-color,box-shadow] duration-150 placeholder:text-merkao-muted focus:border-merkao-primary focus:shadow-[0_0_0_3px_rgba(0,105,72,0.12)]";
...
export const fileInput =
  "w-full rounded-merkao border border-dashed border-merkao-outline bg-merkao-background px-2.5 py-2 text-xs text-merkao-muted file:mr-3 file:rounded-merkao file:border-0 file:bg-merkao-primary file:px-3 file:py-1.5 file:text-xs file:font-bold file:text-white";
...
export const mobileHeader =
  "fixed inset-x-0 top-0 z-50 hidden h-[58px] items-center justify-between border-b border-merkao-border bg-merkao-background px-3 max-[860px]:flex";
...
export const sidebarBase =
  "fixed bottom-0 left-0 top-0 z-[60] flex w-[260px] flex-col gap-4 border-r border-merkao-border bg-merkao-sidebar py-5 max-[860px]:w-[min(280px,86vw)] max-[860px]:shadow-[20px_0_44px_rgba(23,29,25,0.16)] max-[860px]:transition-transform max-[860px]:duration-200";
...
export const navButtonBase =
  "inline-flex min-h-[42px] w-full items-center justify-start gap-4 border-0 border-l-2 border-transparent bg-transparent px-6 py-3 text-[13px] font-semibold text-merkao-muted transition-colors duration-150 hover:border-merkao-outline hover:bg-merkao-surfaceAlt hover:text-merkao-text [&_svg]:h-[17px] [&_svg]:w-[17px]";
export const navButtonActive = "border-l-merkao-primary bg-merkao-primarySoft text-merkao-primary";
export const drawerClose = "ml-auto !hidden max-[860px]:!inline-flex";
export const userBox = "mt-auto grid grid-cols-[auto_minmax(0,1fr)] items-center gap-2 border-t border-merkao-border px-5 pt-3.5";
...
export const main = "ml-[260px] min-h-screen min-w-0 pb-7 max-[860px]:ml-0 max-[860px]:pb-[82px] max-[860px]:pt-[58px]";
export const topbar =
  "sticky top-0 z-40 flex h-16 items-center justify-between gap-4 border-b border-merkao-border bg-merkao-background px-6 max-[860px]:hidden";
export const topSearch =
  "flex min-h-9 w-full max-w-[420px] items-center gap-2 rounded-merkao border border-merkao-border bg-merkao-surface px-2.5 text-merkao-muted";
...
export const pageHeader =
  "mx-auto flex w-full max-w-[1440px] items-center justify-between gap-4 px-6 pb-3 pt-5 max-[860px]:items-start max-[860px]:px-3 max-[860px]:py-3";
export const pageTitle = "m-0 text-2xl font-extrabold leading-[1.2] max-[860px]:text-[22px]";
...
export const summaryCard =
  "grid min-h-[104px] gap-2 rounded-merkao border border-merkao-border bg-merkao-surface p-3.5 max-[860px]:min-h-[96px] max-[860px]:p-3";
...
export const summaryValue = "text-[22px] leading-none text-merkao-text max-[860px]:text-[20px]";
...
export const toolbar =
  "flex items-center justify-between gap-3 rounded-merkao border border-merkao-border bg-merkao-surface px-3 py-2.5 max-[860px]:flex-col max-[860px]:items-stretch";
...
export const searchBox =
  "flex min-h-9 w-full max-w-[320px] items-center gap-2 rounded-merkao border border-merkao-border bg-merkao-background px-2.5 text-merkao-muted max-[860px]:max-w-none";
export const helperText = "m-0 text-[11px] leading-4 text-merkao-muted";

export const tableWrap = "overflow-auto rounded-merkao border border-merkao-border bg-merkao-surface";
export const table = "w-full min-w-[860px] border-collapse";
export const th = "border-b border-merkao-border bg-merkao-surfaceAlt px-4 py-2.5 text-left align-middle text-[10px] font-black uppercase text-merkao-muted";
export const td = "border-b border-merkao-border px-4 py-3 text-left align-middle text-[13px] text-merkao-text";
export const tableStrong = "block font-extrabold";
export const productCell = "flex min-w-60 items-center gap-2.5";
export const productImage = "h-10 w-10 rounded-merkao border border-merkao-border bg-merkao-surfaceAlt object-cover";
export const catalogImage = "h-9 w-9 rounded-merkao border border-merkao-border bg-merkao-surfaceAlt object-cover";
...
export const paginationBar =
  "flex items-center justify-between gap-3 rounded-merkao border border-merkao-border bg-merkao-surface px-3 py-2.5 max-[640px]:flex-col max-[640px]:items-stretch";
export const paginationText = "text-xs font-bold text-merkao-muted";
export const paginationSizeLabel = "inline-flex items-center gap-2 text-xs font-bold text-merkao-muted";
export const paginationSelect =
  "h-8 rounded-merkao border border-merkao-border bg-white px-2 text-xs font-bold text-merkao-text outline-none";
export const paginationActions = "flex items-center justify-end gap-2";

export const pillBase = "inline-flex rounded-[3px] px-2 py-1 text-[10px] font-black";
...
const statusPillClasses: Record<OrderStatus, string> = {
  ...
  PREPARING: "bg-[#d4e4fa] text-[#0d1c2d]",
  ON_THE_WAY: "bg-[#d8e3fb] text-[#111c2d]",
...
export const railCard = "overflow-hidden rounded-merkao border border-merkao-border bg-merkao-surface";
export const railHeader = "flex min-h-12 items-center justify-between gap-2.5 border-b border-merkao-border px-3 py-[11px]";
...
export const panelSurface = "rounded-merkao border border-merkao-border bg-merkao-surface";
export const modalOverlay =
  "fixed inset-0 z-[75] border-0 bg-[rgba(23,29,25,0.45)] p-0 backdrop-blur-sm";
export const modalPanel =
  "fixed left-1/2 top-1/2 z-[80] grid max-h-[90vh] -translate-x-1/2 -translate-y-1/2 gap-3.5 overflow-auto rounded-merkaoPanel border border-merkao-border bg-merkao-surface p-4 shadow-[0_24px_80px_rgba(23,29,25,0.28)]";
export const drawer =
  cn(modalPanel, "w-[min(600px,calc(100vw-32px))]");
export const catalogModal = cn(modalPanel, "w-[min(440px,calc(100vw-32px))]");
...
export const listPanel = "grid gap-2 rounded-merkao border border-merkao-border bg-merkao-surface p-3";
export const listRow = "flex items-center justify-between gap-2 rounded-merkao bg-merkao-background px-3 py-2";
export const timelineItem = "grid grid-cols-[12px_minmax(0,1fr)] gap-2 rounded-merkao bg-merkao-background px-3 py-2";
export const timelineDot = "mt-1.5 h-2.5 w-2.5 rounded-full bg-merkao-primary";
...
export const loginPanel = cn(panelSurface, "mx-auto grid w-full max-w-[380px] gap-3.5 p-4 shadow-[0_18px_50px_rgba(23,29,25,0.08)]");
export const modalActions =
  "sticky bottom-0 -mx-4 -mb-4 mt-1 flex justify-end gap-2 border-t border-merkao-border bg-merkao-surface px-4 py-3";

export const bottomBar =
  "fixed inset-x-0 bottom-0 z-[45] hidden h-16 items-center justify-around border-t border-merkao-border bg-merkao-surface px-2 pb-[7px] pt-[5px] max-[860px]:flex";
